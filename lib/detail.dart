...
//  AssetImage _imageToShow ;
  ...
  Widget itemImage;
  asd(BuildContext context, int index) {
    return Container(
  ...
  Widget build(BuildContext context) {
    var assetsImage = new NetworkImage(
        'http://dev.farizdotid.com/api/halopwk/gambar/wisata/gambar_1.jpg'); //<- Creates an object that fetches an image.
            ...
            Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(
                      'Alun-alun kota & tempat nongkrong sore populer, dengan area beraspal & taman, patung & air mancur. Tidak ada tarif jika anda ingin berwisata disini.',
                      style: TextStyle(
                        fontFamily: 'Montserrat',
                        fontSize: 20,
                      ),
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(padding: EdgeInsets.all(16.0)),
                      Text(
                        'hotelnya terkenal sangat mewah, namun harganya terjangkau, tidak lebih dari 1juta permalam, kita sudah dapat menginap dihotel yang super mewah, dengan pemandangan laut yang menyejukkan mata, tentunya juga, makanan sekelas italia disajikan di hotel ini.',
                        style: TextStyle(
                          fontFamily: 'Montserrat',
                          fontSize: 20,
                        ),
              ...
              Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(padding: EdgeInsets.all(16.0)),
                      Text(
                        'kuliner disini terkenal paling enak, tempatnya juga nyaman ditambah dengan pelayanan yang sangat memuaskan, kita juga bisa menikmati pemandangan sekitar dengan udara yang sejuk sambil menyantap makanan yang disajikan.',
                        style: TextStyle(
                          fontFamily: 'Montserrat',
                          fontSize: 20,
                        ),
